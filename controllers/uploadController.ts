 ...
 * POST /api/upload/image (now uses Cloudinary instead of disk)
 */
 ...
 * POST /api/upload/images (now uses Cloudinary instead of disk)
 */
 ...
 * POST /api/upload/product-media (now uses Cloudinary instead of disk)
 */
 ...
 * POST /api/upload/avatar (now uses Cloudinary instead of disk)
 */
 ...
 * DELETE /api/upload/:filename (kept for backward compatibility with local uploads)
 */
